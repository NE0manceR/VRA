  ...
  howWeWork: [
    {
      ...
      description: 'Бізнес-цілі Потреби користувача Завдання проєкту',
    },
    {
      id: 1,
      icon: '/img/HomePage/howWeWork/Vector2.svg',
      title: 'Проектування та дизайн',
      description: 'Розробка концепції Прототипи Створення та підготовка макетів',
    },
    {
      id: 2,
      icon: '/img/HomePage/howWeWork/Vector3.svg',
      title: 'Погодження та виробництво',
      description: 'Фінальні правки Виготовлення продукції Доставка',
    },
  ],
