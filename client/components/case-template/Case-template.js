  ...
  let goalsArr = [
    {
      id: 0,
      text:
        'До нас звернувся клієнт - новостворена у Львові клініка естетичної хірургії GENESIS. \n Завдання стояло неординарне - потрібно було виготовити ряд ексклюзивних речей, а саме:',
      circleStatus: false,
    },
    {
      id: 1,
      text: 'Візитки з прозорим логотипом',
      circleStatus: true,
    },
    {
      id: 2,
      text: '     Значки з вмістом дорогоцінних металів',
      circleStatus: true,
    },
    {
      id: 3,
      text: 'Пакети з об’ємним логотипом та зав’язками для косметичної продукції',
      circleStatus: true,
    },
  ];

  let photoArr = [
    { id: 0, src: '/img/cases/3.png' },
    { id: 1, src: '/img/cases/7.png' },
    { id: 2, src: '/img/cases/3.png' },
    { id: 3, src: '/img/cases/3.png' },
    { id: 4, src: '/img/cases/3.png' },
  ];

  let nextCaseArr = [
    {
      id: 0,
      photoSrc: "url('/img/template/1.png')",
      caseName: 'NEF',
      link: '',
      type: 'Брендування',
    },
    {
      id: 1,
      photoSrc: "url('/img/template/2.png')",
      caseName: 'FAAC',
      link: '',
      type: 'Логотип та фірмовий стиль',
    },
  ];
    ...
    <div ref={caseRef} style={{ position: 'relative' }}>
      <div className="Case-Template showPage">
        ...
        <div className="Case-template_grid">
          <img src="img/template/GenesisLogo.png" alt="img" />
          <div className="Template-text">
            <p className="subtitle1">Клієнт</p>
            <p className="subtitle2 client">БУК ХОЛДІНГ</p>
            <p className="subtitle1">Дата</p>
            <p className="subtitle2 date">2 червня 2019</p>
            <p className="subtitle1">Категорія</p>
            <p className="subtitle2">Дизайн</p>

            {/* включати тільки для логотипів */}
            {author ? (
              <Fragment>
                <p className="subtitle1 author">Автор проєкту</p>
                <p className="subtitle2 author-name">Віталіна Крохмаль</p>
                <p className="subtitle1">Переглянути презентацію</p>
                <a target="__blank" href="/img/template/GenesisLogo.png">
            ...
            <div className="Template-share">
              <div className={`TemplateIcons ${linkCopy ? 'showTips' : ''} `}>
                ...
                <EmailShareButton url={''} className="Demo__some-network__share-button">
                  <svg
                    width="18"
                    height="18"
                    viewBox="0 0 18 18"
                ...
                <ViberShareButton url={''} className="Demo__some-network__share-button">
                  <svg
                    width="18"
                    height="18"
                    viewBox="0 0 18 18"
                ...
                <TelegramShareButton url={''} className="Demo__some-network__share-button">
                  <svg
                    width="18"
                    height="18"
                    viewBox="0 0 18 18"
      ...
      <div className="Descr-bcg">
        <div className="Case-description">
          <div className="Case-title-wrap">
            {' '}
            <h3 className="Case-title">Візитки</h3>
            <h3>БУК ХОЛДІНГ</h3>
          </div>
          <div className="Goals">
            <div className="Goal">
              ...
              {goalsArr.map(({ text, id, circleStatus }) => {
                return (
                  <div
                    key={id}
                    className={`Goals__dot-wrap-no-active ${
                      circleStatus ? 'Goals__dot-wrap-active' : null
                    }`}
                  >
                    {circleStatus ? <div className="Goals__dot" /> : null}
                    <span className="Goals__text">{text}</span>
                  </div>
                );
              })}
            </div>
            <div className="Tasks">
              <span className="Tasks-title">Задача для агентства</span>
              <ol>
                <li>Розробка дизайну корпоративної візитки.</li>
                <li>Виготовлено іменні візитки..</li>
                <li>Офсетний та лазерний друк з глянцевою ламінацією.</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <div className="Project-photo">
        ...
        <div
          className={`Project-photo__wrap Project-photo-grid-${photoArr[photoArr.length - 1].id}`}
        >
          {photoArr.map(({ id, src }) => {
            return (
              <div
                ...
                key={id}
                className={`Project-photo__bcg area-${id}`}
      ...
      <div className="Next-bcg Next">
        <div className="Next__wrap">
          ...
          <div className="Next__projects">
            {nextCaseArr.map(({ id, link, photoSrc, caseName, type }) => {
              return (
                <div key={id}>
                  <div className="Next__projects_img" style={{ background: photoSrc }} />
                  <div className="Next__project-text">
                    <Link to={link}>{caseName}</Link>
                    <span>{type}</span>
                  </div>
                </div>
              );
