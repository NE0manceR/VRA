        ...
        <div className="Hero Grid">
          ...
          <div className="Hero__text-wrap">
            ...
            <form action="">
              ...
              <p>
                <span className="form-alert">Зверніть увагу!</span> Якщо розмір ваших файлів
                перевищує <span className="file-weight">100MB</span>, прикріпляйте у повідомлення
                посилання на хмарне сховище (Google Drive, Dropbox тощо){' '}
              </p>
