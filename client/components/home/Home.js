...
import Slider from '../common/Slider/Slider/Slider';
...
const Home = () => {
      ...
      souvenirs: [
        {
          ...
          description: 'Project Name',
          blockClass: 'Gallery__photo-1',
          photo: '/img/HomePage/gallery/photo3.png',
          link: '/test11',
          category: 'souvenirs',
        },
        {
  ...
  let allPhotos = [
    photos[0]['design'][0],
    photos[0]['printing'][1],
    photos[0]['souvenirs'][2],
    photos[0]['visual'][3],
    photos[0]['textile'][4],
  ];

  let [addPhoto, setaddPhoto] = useState(allPhotos);
  let [grid, setGrid] = useState(0);

  let changeCategory = (category = 'all') => {
    if (category === 'all') {
      setGrid(5);
      setaddPhoto(allPhotos);
    } else {
      setaddPhoto(photos[0][category]);
      setGrid(photos[0][category].length);
    }
  };
    ...
    <div className="Home">
        ...
        <div className="Advertising-bcg">
          <div ref={grandFather} className="Advertising">
            ...
            <div className="Advertising__text">
              ...
              <p className="Description">
                VRA на ринку реклами та поліграфічних послуг вже понад чверть століття. За цей час
                ми не лише реалізували кілька мільйонів замовлень, але й заручилася підтримкою тисяч
                клієнтів та утворили більш ніж 20 самостійних структур.
              </p>
      ...
      <Reveal effect="fadeInUp">
        <div className="Best Grid">
          ...
          <p className="Description Best_description">
            Пропонуємо широкий спектр послуг! Друк на найрізноманітніших матеріалах, розробку бренду
            та його просування, виготовляємо сувеніри та вивіски, а також оформлюємо вітрини та
            інтер’єри.
          </p>
              ...
              return (
                <div key={box.id} className="Best__card-wrap">
                  ...
                  <div
                    ...
                    style={{ background: `url("${box.img}")no-repeat` }}
                  ></div>
                  <span>{box.title}</span>
                </div>
              );
      ...
      <Reveal effect="fadeInUp">
        <div className="OurWorks-bcg">
          <div className="OurWorks Grid">
            ...
            <HomeTabs
              changeCaseType={() => {}}
              changeHomeCategory={changeCategory}
          ...
          <div className="Technology Grid">
            <div className="Technology__photo">
              {technology.map(({ photo, text, id, link, hoverText }) => {
                return (
                  <div
                    className="Technology__photo-frame"
                    key={id}
                    style={{ background: `url("${photo}") no-repeat`, backgroundSize: 'cover' }}
                  >
            ...
            <div className="Technology__text">
              ...
              <p className="Description Technology_Descr-position">
                Обираємо з поміж тисячі технологій та матеріалів, аби ваш продукт був якісним та
                неповторним.
              </p>
