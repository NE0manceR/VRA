    ...
    <div>
      <div className="Case showPage">
                  ...
                  >
                    <div className="black-bcg">
                      <div className={`content-wrap `}>
                        ...
                        <GradientBtn1
                          className="Case__btn-link"
                          to={`/case/${itemCase.Link}`}
                          link={true}
                        >
                          Переглянути кейс
                        </GradientBtn1>
                        <div className={`icons  ${linkCopy ? 'icon-copy-text' : ''}`}>
                          <div className="Cases__share-link">
                            <svg
                              width="24"
                              height="24"
                              viewBox="0 0 24 24"
                          ...
                          <EmailShareButton
                            url={`/case${itemCase.Link}`}
                            className="Demo__some-network__share-button Cases__share-email"
                          >
                            <svg
                              width="24"
                              height="24"
                          ...
                          <ViberShareButton
                            url={`/case${itemCase.Link}`}
                            className="Demo__some-network__share-button Cases__share-viber"
                          >
                            <svg
                              width="22"
                              height="22"
                          ...
                          <TelegramShareButton
                            url={`/case${itemCase.Link}`}
                            className="Demo__some-network__share-button Cases__share-telegram"
                          >
                            <svg
                              width="24"
                              height="24"
        ...
        <div className="Case__btn-wrap">
          {howManyShow <= items.length ? (
            <WhiteBtn morePhotoInLogo={showMorePhoto}>Розгорнути більше</WhiteBtn>
          ) : null}
        </div>
        <Order></Order>
      </div>
