      ...
      <div className="Hero-bcg">
        <div className="Hero Grid">
          ...
          <div className="Payment__text-wrap">
            <p className="Payment__main-title">
              Як розрахуватись за надані послуги? Для вашої зручності пропонуємо настузпні способи
              оплати:
            </p>
            <div>
              <p className="Payment__second-title">1. Готівкою під час отримання замовлення:</p>
              <p className="Payment__text">
                <span className="text-dot"></span> у відділеннях Нової Пошти;
              </p>
              <p className="Payment__text">
                <span className="text-dot"></span>кур’єрові Нової Пошти, чи інших сервісів доставки.
              </p>
            </div>
            <div>
              <p className="Payment__second-title">2. Переказом на картку:</p>
              <p className="Payment__text">
                <span className="text-dot"></span>
                Приват Банку, використовуючи Приват24 або платіжний термінал;
              </p>
              <p className="Payment__text">
                <span className="text-dot"></span>
                МоноБанку, через додаток МоноБанк або платіжний термінал.
              </p>
              <p className="Payment__text">
                Як тільки ваші кошти надійдуть до нас, наші працівники одразу ж почнуть роботу над
                вашим замовленням
              </p>
            </div>
            <div>
              <p className="Payment__second-title">3. Безготівкою на рахунок підприємства:</p>
              <p className="Payment__text">
                Для зручності корпоративних клієнтів оплату замовлення можна провести безпосередньо
                на розрахунковий рахунок підприємства. Для цього ми надішлемо вам рахунок, а після
                його оплати одразу розпочнемо роботу над замовленням!
              </p>
            </div>
            <div className="Payment__block-wrap">
              <div className="Payment__block">
                <p className="Payment__block-title">Платіть безпечено</p>
                <p className="Payment__block-text">Зручні способи оплати</p>
                <p className="Payment__block-text">Жодної комісії під час отримання</p>
              </div>
              <div className="Payment__block">
                <p className="Payment__block-title">Отримуйте швидко</p>
                <p className="Payment__block-text">Короткі терміни виконання замовлення</p>
                <p className="Payment__block-text">Безкоштовна доставка замовлення від 1000 грн.</p>
                <p className="Payment__block-text">Послуги кур’єра</p>
              </div>
              <div className="Payment__block">
