...
function Gallery(props) {
  ...
  return (
    <div className={`Gallery-wrap ${props.className}`}>
              ...
              {startCount++ <= showPhoto ? (
                ...
                >
                  ...
                  <div className="content-wrap">
                    ...
                    <GradientBtn1 link={true} to={item.link} className="gallery-btn">
                      Переглянути кейс
                    </GradientBtn1>
      ...
      {props.link ? (
        <div className="btn-wrap">
          {showPhoto <= props.addPhoto.length ? <WhiteBtn link>Переглянути більше</WhiteBtn> : null}
        </div>
      ) : null}
    </div>
  );
