    ...
    <div className={`Gallery-wrap ${props.className}`}>
      <div className={`Gallery Gallery-${props.gridNumber}`}>
        {props.addPhoto.map((item) => {
          return (
            <div className={`Gallery__photo_hover ${item.blockClass}`} key={item.id}>
              <div className="Gallery__blur" style={{ background: `url("${item.photo}")` }}></div>
              <div className="content-wrap">
                ...
                <div className={`icons ${linkCopy ? 'icon-copy-text' : ''}`}>
                  ...
                  <EmailShareButton url={item.link} className="Demo__some-network__share-button">
                    <svg
                      width="18"
                      height="18"
                      viewBox="0 0 18 18"
                  ...
                  <ViberShareButton url={item.link} className="Demo__some-network__share-button">
                    <svg
                      width="18"
                      height="18"
                      viewBox="0 0 18 18"
                  ...
                  <TelegramShareButton url={item.link} className="Demo__some-network__share-button">
                    <svg
                      width="18"
                      height="18"
                      viewBox="0 0 18 18"
      ...
      {props.btn ? (
        <div className="btn-wrap">
          <WhiteBtn>Переглянути більше</WhiteBtn>
        </div>
      ) : null}
    </div>
  );
